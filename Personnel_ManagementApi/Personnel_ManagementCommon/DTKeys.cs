...
namespace DTcms.Common
{
    public class DTKeys
    {
        ...
        /// 服务时间配置文件名
        /// </summary>
        public const string FILE_TIMESET_XML_CONFING = "TimeSetpath";
        ...
        /// 服务时间配置LIST列表
        /// </summary>
        public const string CACHE_SITE_TIMESET_LIST = "dt_cache_site_timeset_list";
        ...
        /// <summary>
        /// 美美洗APP下载链接 http://mmcleaner.malltang.com/app_service/webapp/download.aspx 
        /// </summary>
        public const string APP_DOWN_URL = "http://mmcleaner.malltang.com/app_service/webapp/download.aspx";

        /// <summary>
        /// 美美洗洗衣房动态二维码URL 
        /// </summary>
        public const string APP_BIZQR_URL = "http://mmcleaner.malltang.com/app_service/webapp/bizqr.aspx?bizid={0}"; 

        /// <summary>
        /// 美美洗用户与设备绑定关系时限，单位分钟，目前为20分钟  
        /// </summary>
        public static int APP_RELATION_KEEPTIME = 20;
    }
}
