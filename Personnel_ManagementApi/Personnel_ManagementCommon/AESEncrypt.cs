...
namespace DTcms.Common
{
    public class AESEncrypt
    {
        ...
        /// 密钥(32位,不足在后面补0) 
        /// </summary> 
        private const string _passwd = "mmhomener0037J7uT*)(OKJY*(()JI^)"; //mmcleaner0037J7uT*)(OKJY*(()JI^)IO%
        /// <summary> 
        /// 运算模式 
        /// </summary> 
        ...
        /// <param name="password">密码</param> 
        /// <returns></returns> 
        private static byte[] Encrypt(byte[] inputData, string password)
        {
        ...
        /// <summary> 
        /// 解密16进制的字符串为字符串，异常时返回string.Empty  
        /// </summary> 
        ...
        /// <param name="password">密码</param> 
        /// <returns></returns> 
        private static byte[] Decrypt(byte[] inputData, string password)
        {
            AesCryptoServiceProvider aes = new AesCryptoServiceProvider();
            aes.Key = GetKeyArray(password);
            aes.Mode = _cipherMode;
